...
oisst_path   <- cs_path(box_group = "RES_Data", subfolder = "OISST/oisst_mainstays")
...
Regionally averaged temperatures were computed using the {exactextractr} package for the R statistical
computing language. 

Making spatial object for MAB Slope, shelf was not used. Details on making the shapefiles for extracting 
temperature data has been added to the supplementary materials
